 ...
 * @since 12/13/11, 10:04 AM
 */
public class AopCreatorTemplateData extends AbstractTemplateData {

    private List<ClassScanModel> classScanModels;
    private List<ClassScanModel> interceptorClassModels;

    public AopCreatorTemplateData(String generateClassName, String generatePackageName) {
