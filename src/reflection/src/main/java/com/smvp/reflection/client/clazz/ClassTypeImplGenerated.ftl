[#ftl]
[#-- @ftlvariable name="data" type="com.smvp.reflection.generator.reflection.ClassTypeTemplateData" --]
/*
...
import com.smvp.reflection.client.clazz.*;
import com.smvp.reflection.client.annotation.*;
import com.smvp.reflection.client.field.*;
import com.smvp.reflection.client.method.*;
import com.smvp.reflection.client.executor.*;
