[#ftl]
[#-- @ftlvariable name="data" type="net.smvp.reflection.generator.reflection.ClassTypeTemplateData" --]
/*
...
import net.smvp.reflection.client.clazz.*;
import net.smvp.reflection.client.annotation.*;
import net.smvp.reflection.client.field.*;
import net.smvp.reflection.client.method.*;
import net.smvp.reflection.client.executor.*;
